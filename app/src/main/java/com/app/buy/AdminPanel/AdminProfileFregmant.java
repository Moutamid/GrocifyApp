...
public class AdminProfileFregmant extends Fragment {

    //----------------------------
    private ImageView UserImage;
    private TextView UserName, UserEmail, UserPhone, logout, order, about_text;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        about_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showEditAboutDialog(about_text.getText().toString());
            }
        });
...
//                startActivity(new Intent(getContext(), OrderActivity.class));
    ...
    private void showEditAboutDialog(String currentAbout) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
        View dialogView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_edit_about, null);
        builder.setView(dialogView);

        EditText editAbout = dialogView.findViewById(R.id.editAbout);
        Button saveBtn = dialogView.findViewById(R.id.saveBtn);
        Button cancelBtn = dialogView.findViewById(R.id.cancelBtn);

        editAbout.setText(currentAbout);
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String updatedAbout = editAbout.getText().toString().trim();
                if (updatedAbout.isEmpty()) {
                    editAbout.setError("Please enter about info");
                    return;
                }

                DatabaseReference ref = FirebaseDatabase.getInstance()
                        .getReference().child("PharmacyApp")
                        .child("Pharmacies")
                        .child(FirebaseAuth.getInstance().getCurrentUser().getUid());

                ref.child("about").setValue(updatedAbout)
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(getContext(), "Updated successfully", Toast.LENGTH_SHORT).show();
                            about_text.setText(updatedAbout);
                            dialog.dismiss();
                        })
            ...
            fileRef.putFile(imageUri)
                    .addOnSuccessListener(taskSnapshot -> fileRef.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        DatabaseReference dbRef = FirebaseDatabase.getInstance()
                                .getReference().child("PharmacyApp").child("Pharmacies").child(userId);
