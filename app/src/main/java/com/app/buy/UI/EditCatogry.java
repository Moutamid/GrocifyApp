...
import com.app.buy.Model.Catogry;
...
public class EditCatogry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdataReference = FirebaseDatabase.getInstance("https://sos-app-63a86-default-rtdb.firebaseio.com/").getReference().child("PharmacyApp").child("categories");
        ...
        StorageReference httpsRef = FirebaseStorage.getInstance("gs://sos-app-63a86.appspot.com").getReference().child("PharmacyApp").child("categories");
...
//                Toast.makeText(EditCatogry.this, e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void uploadImage() {
        if (imgUri.toString().equals(oldImagePath)) {
            ...
            a.child("image").setValue(b.getString("img"));
