            ...
            public void onItemLongClick(final int pos) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(getActivity()).setTitle("Confirmation").setMessage("Are You Sure You Want To Delete ?!").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        StorageReference z = FirebaseStorage.getInstance("gs://grocery-delivery-app-22f4e.appspot.com").getReference("offers").child(adminProducts.get(pos).getName() + ".jpg");
                        z.delete();
                        StorageReference x = FirebaseStorage.getInstance("gs://grocery-delivery-app-22f4e.appspot.com").getReference("offers").child(adminProducts.get(pos).getName());
                        x.delete();
                    }
