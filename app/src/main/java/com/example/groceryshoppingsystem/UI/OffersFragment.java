...
public class OffersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mDataBaseRef = FirebaseDatabase.getInstance("https://grocery-delivery-app-22f4e-default-rtdb.firebaseio.com/").getReference("offers");
        ...
        adapter.setOnItemClickListener(new AdminOfferAdapter.onItemClickListener() {
            ...
            public void onItemClick(int pos) {
                ...
                Bundle b = new Bundle();
                b.putString("image" , OfferList.get(pos).getOfferImg());
            ...
            public void onItemLongClick(final int pos) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(getActivity()).setTitle("Confirmation").setMessage("Are You Sure You Want To Delete ?!").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        StorageReference z = FirebaseStorage.getInstance("gs://grocery-delivery-app-22f4e.appspot.com").getReference("offers").child(OfferList.get(pos).getOfferName() + ".jpg");
                        z.delete();
                        StorageReference x = FirebaseStorage.getInstance("gs://grocery-delivery-app-22f4e.appspot.com").getReference("offers").child(OfferList.get(pos).getOfferName());
                        x.delete();
                    }
